...
void updateControl(){
  ...
  }  // && siginifica "e"...ver ref. Arduino em "Boolean Operators"
  else{
    envelope.noteOff();
  }
}
...
int updateAudio(){
  return (oscillator.next() * envelope.next()) >> 8; // return an int signal centred around 0
}
